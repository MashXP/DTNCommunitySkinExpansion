...
public class Ninetales {
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mane_rotation_r1 = upper_body.addOrReplaceChild("mane_rotation_r1", CubeListBuilder.create().texOffs(25, 2).addBox(-1.0F, -3.0F, -3.0F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-1.0F, -1.75F, 2.25F, -0.9163F, 0.0F, 0.0F));

		PartDefinition mane_rotation_r2 = upper_body.addOrReplaceChild("mane_rotation_r2", CubeListBuilder.create().texOffs(29, 2).mirror().addBox(-1.75F, -0.5F, -1.95F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(-3.0F, -1.7F, -2.8F, 0.0F, 0.0F, -1.5708F));

		PartDefinition mane_rotation_r3 = upper_body.addOrReplaceChild("mane_rotation_r3", CubeListBuilder.create().texOffs(29, 2).mirror().addBox(-1.0F, -1.5F, -1.95F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(-3.3F, -1.0F, -0.3F, 0.0F, 0.0F, -1.5708F));

		PartDefinition mane_rotation_r4 = upper_body.addOrReplaceChild("mane_rotation_r4", CubeListBuilder.create().texOffs(29, 2).mirror().addBox(-0.25F, -0.5F, -3.05F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.3F, 1.25F, -0.55F, 0.0F, 0.0F, -1.5708F));

		PartDefinition mane_rotation_r5 = upper_body.addOrReplaceChild("mane_rotation_r5", CubeListBuilder.create().texOffs(29, 2).addBox(-1.75F, -0.5F, -3.05F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3F, 1.25F, -0.55F, 0.0F, 0.0F, 1.5708F));

		PartDefinition mane_rotation_r6 = upper_body.addOrReplaceChild("mane_rotation_r6", CubeListBuilder.create().texOffs(29, 2).addBox(-1.0F, -1.5F, -1.95F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(3.3F, -1.0F, -0.3F, 0.0F, 0.0F, 1.5708F));

		PartDefinition mane_rotation_r7 = upper_body.addOrReplaceChild("mane_rotation_r7", CubeListBuilder.create().texOffs(29, 2).addBox(-0.25F, -0.5F, -1.95F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(3.0F, -1.7F, -2.8F, 0.0F, 0.0F, 1.5708F));
		...
		.texOffs(0, 0).addBox(-3.0F, 1.2F, -2.0F, 6.0F, 2.0F, 4.0F, new CubeDeformation(-0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
